...
def adjustment_step() -> uint256:
    """
    @notice Returns the current adjustment step (max price adjustment per rebalance)
...
def apply_new_parameters(
    ...
    @param _new_adjustment_step The new adjustment step (max price adjustment per rebalance).
